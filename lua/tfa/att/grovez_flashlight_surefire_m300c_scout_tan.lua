...
ATTACHMENT.Name = "Surefire M300C (Scout mount, Tan)"
ATTACHMENT.ShortName = "M300C"
ATTACHMENT.Icon = "entities/grovez_flashlight_surefire_m300c_scout_tan.png"
...
ATTACHMENT.WeaponTable = {
	...
	["ViewModelBoneMods"] = {
		["lightsource"] = {scale = Vector(1, 1, 1), pos = Vector(-1.61, -15.45, 3.8), angle = Angle(0, 0, 0)}
	},
